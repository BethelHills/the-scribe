...
export default function AIChat() {
  ...
  return (
    <div className="flex h-full min-h-[420px] flex-col rounded-[28px] border border-card-border bg-card text-foreground shadow-sm sm:min-h-[520px] sm:rounded-[32px] lg:min-h-[640px]">
      ...
      <div className="border-t border-card-border p-4 sm:p-5">
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-accent text-white sm:h-12 sm:w-12 ${buttonInteractions} hover:opacity-90 active:opacity-80 disabled:opacity-50`}
          >
            <Send size={18} />
          </button>
        </div>
